...
| `kpsc-oj-frontend/src/types/problemApi.ts` | file | 문제 API DTO 타입 | API DTO contract | 문제 목록/상세/정의/생성/수정 request/response DTO, 목록 생성자 식별 필드, optional checker field를 정의한다. |
